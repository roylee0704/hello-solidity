...
module.exports = async function (deployer) {
  ...
  const name = "Colorverse"
  const symbol = "POPCORN"
  ...
  // Distribute 50 POPCORN token to 5 voters.
  ...
  // Deploy: governance
  const quorum = 5 // Percentage of total supply of tokens needed to approve proposals (5%)
